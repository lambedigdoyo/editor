...
x_aTs.push(new x_aT('x_reset_css', 'reset.css', '<link href=https://cdn.jsdelivr.net/gh/lambedigdoyo/editor@main/src/css/gr-reset.css rel=stylesheet />',''));
x_aTs.push(new x_aT('x_setTa', 'set_tArea.js', '<script src=https://cdn.jsdelivr.net/gh/lambedigdoyo/editor@main/src/js/textarea-attr.js><\/script>',''));
x_aTs.push(new x_aT('x_jq1', 'jq_1.9.1.js', '<script src=https://cdn.jsdelivr.net/gh/lambedigdoyo/lib@main/jquery/jquery_1.9.1.min.js><\/script>',''));
x_aTs.push(new x_aT('x_cm_doc_css', 'CM-doc.css', '<link href=https://cdn.jsdelivr.net/gh/lambedigdoyo/editor@main/codemirror/doc/docs.css rel=stylesheet />',''));
x_aTs.push(new x_aT('x_cm_demo_css', 'CM-demo.css', '<link href=https://cdn.jsdelivr.net/gh/lambedigdoyo/editor@main/codemirror/combined/codemirror-all.css rel=stylesheet />',''));
x_aTs.push(new x_aT('x_cm_js', 'CM-all.js', '<script src=https://cdn.jsdelivr.net/gh/lambedigdoyo/editor@main/codemirror/combined/codemirror-all.js><\/script>',''));
