...
x_aTs.push(new x_aT('x_reset_css', 'reset.css', '<link href=file:///D:/www.GR.net/lib/css/gr-reset.css rel=stylesheet />',''));
x_aTs.push(new x_aT('x_setTa', 'set_tArea.js', '<script src=file:///D:/www.GR.net/lib/js/textarea-attr.js><\/script>',''));
x_aTs.push(new x_aT('x_jq1', 'jq_1.9.1.js', '<script src=file:///D:/www.GR.net/lib/jquery/jquery_1.9.1.min.js><\/script>',''));
x_aTs.push(new x_aT('x_cm_doc_css', 'CM-doc.css', '<link href=file:///D:/www.GR.net/CM/5/doc/docs.css rel=stylesheet />',''));
x_aTs.push(new x_aT('x_cm_demo_css', 'CM-demo.css', '<link href=file:///D:/www.GR.net/CM/byGR/lib/css/simple-preview.css rel=stylesheet />',''));
x_aTs.push(new x_aT('x_cm_js', 'CM-all.js', '<script src=file:///D:/www.GR.net/CM/byGR/lib/js/codemirror-all.js><\/script>',''));
...
x_aTs.push(new x_aT('x_jq2', 'jq_3.5.1.js', '<script src=file:///D:/GR/FIX/lib/jquery/jquery_3.5.1.min.js><\/script>',''));
